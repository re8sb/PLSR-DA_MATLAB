READ ME
Dolatshahi Lab (O)PLSR/DA package
6/25/2021
...
scores_plot: Plots the X scores on LV1 and LV2, and reports the percent variance captured in both X and Y for either component.
